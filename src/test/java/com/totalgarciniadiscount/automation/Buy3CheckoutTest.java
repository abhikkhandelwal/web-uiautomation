...
public class Buy3CheckoutTest extends TestBase {
	...
	public void buy3CheckoutTest(String FirstName, String LastName,
		...
		Reporter.log("Click on add to cart button of buy one bottle");

		WebUIAutomation.isObjPresent("btn_addtocartbuy3_purchase", 20);
		if (!WebUIAutomation.clickObj("btn_addtocartbuy3_purchase")) {
