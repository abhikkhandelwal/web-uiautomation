...
public class Buy1CheckoutTest extends TestBase{
	@BeforeTest
	...
	public void buy1CheckoutTest(String FirstName, String LastName,
		...
		// Click on add to cart button of buy one bottle
		WebUIAutomation.isObjPresent("btn_addtocartbuy1_purchase", 20);
		if (!WebUIAutomation.clickObj("btn_addtocartbuy1_purchase")) {
		...
		if (WebUIAutomation.getObject("txt_error_msg").getText()
				.equalsIgnoreCase("There Seems To Be A Problem!")) {
